 ...
 */
final class Version20240126094114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE administration (id INT AUTO_INCREMENT NOT NULL, parent_id INT NOT NULL, family_income VARCHAR(255) DEFAULT NULL, tax_return VARCHAR(255) DEFAULT NULL, caf_number VARCHAR(7) DEFAULT NULL, social_number VARCHAR(15) DEFAULT NULL, residency_proof VARCHAR(255) DEFAULT NULL, status_proof VARCHAR(255) DEFAULT NULL, banking_info VARCHAR(255) DEFAULT NULL, discharge VARCHAR(255) DEFAULT NULL, family_record VARCHAR(255) DEFAULT NULL, divorce_decree VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_9FDD0D18727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE child (id INT AUTO_INCREMENT NOT NULL, family_id INT NOT NULL, child_firstname VARCHAR(100) NOT NULL, child_lastname VARCHAR(100) NOT NULL, birthdate DATE NOT NULL, is_walking TINYINT(1) NOT NULL, allergy VARCHAR(255) NOT NULL, is_disabled TINYINT(1) NOT NULL, disability VARCHAR(255) DEFAULT NULL, birth_certificate VARCHAR(255) DEFAULT NULL, doctor_name VARCHAR(255) NOT NULL, vaccine VARCHAR(255) DEFAULT NULL, insurance VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_22B35429C35E566A (family_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
